const ar = {
    translation: {
        title: 'تطبيق الخدمات الالكترونية',
        introduction: `يقوم هذا التطبيق بالعمل على مساعدة مستخدميه في البحث عن بيانات متوفيين ومكان الدفن كما يقوم ايضا بمساعدة مديري النظام في عدة مهام كالاتى:
        فيما يخص إكرام الموتى فيمكنهم من اضافة , عرض , البحث في بيانات متوفين كما يمكنهم من اضافه, عرض بيانات مقبره أما فيما يخص الحراسات الأمنية فيمكنهم من عرض, تعديل و إضافة فترات دوام وحراس و مواقع حراسة`,
        ekram: {
            dead: {
                title: 'إكرام',
                hds: 'تكريم المتوفيين',
        ...
        securityGuards: {
            ...
            shiftTimes: {
                ...
                from: 'الفترة من',
                to: 'الفترة الى',
                timeErr: 'زمن الفترة يجب ان يكون اكبر من 0',
