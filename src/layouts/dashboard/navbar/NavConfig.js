...
const navConfig = [
        ...
        items: [
            {
                ...
                path: '/users',
                icon: <Iconify icon={'ic:round-manage-accounts'} />,
                children: [
                    {
                    ...
                    },
                    {
                        ...
                        icon: <Iconify icon={'fa-solid:users-cog'} />,
                    },
                    {
                        title: 'accounts.permissions.title',
                        path: '/users/permissions',
                        icon: <Iconify icon={'fluent:shield-person-20-filled'} />,
                    },
                    {
                        title: 'accounts.nationalities.title',
                        path: '/users/nationalities',
                        icon: <Iconify icon={'icon-park:international'} />,
                    },
                ],
            },
        ],
    ...
    // Ekram
    {
        subheader: 'ekram.dead.title',
        items: [
            {
                title: 'ekram.dead.title',
                path: '/dead',
                icon: <Iconify icon={'ri:honour-fill'} />,
                children: [
                    {
                        title: 'common.dashboard',
                        path: '/dead',
                    ...
                    {
                        title: 'ekram.dead.hds',
                        path: '/dead/management',
                        icon: <Iconify icon={'mdi:grave-stone'} />,
                    },
                    {
                        title: 'ekram.cemeteries.title',
                        path: '/dead/cemeteries',
                        icon: <Iconify icon={'map:cemetery'} />,
                    },
                ],
            },
        ],
    ...
    // Security Guards
    {
        subheader: 'securityGuards.title',
        items: [
            {
                title: 'securityGuards.title',
                path: '/securityGuards',
                icon: <Iconify icon={'simple-icons:springsecurity'} />,
                children: [
                    {
                        title: 'common.dashboard',
                        path: '/securityGuards',
                    ...
                    {
                        title: 'securityGuards.locations.title',
                        path: '/securityGuards/locations',
                        icon: <Iconify icon={'fa6-solid:map-location-dot'} />,
                    },
                    {
