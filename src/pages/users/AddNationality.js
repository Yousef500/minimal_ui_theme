...
import { Card, CardActions, CardContent, CardHeader, Container, Grid, Stack } from '@mui/material';
  ...
  return (
    <Container>
      <Card component="form" sx={{ borderRadius: 0 }} onSubmit={handleSubmit(handleAddNat)}>
        ...
        <CardActions>
          <Stack direction="row" spacing={3} justifyContent={'center'} width={'100%'} m={2}>
            <LoadingButton
              fullWidth
              type="submit"
              loading={saving}
