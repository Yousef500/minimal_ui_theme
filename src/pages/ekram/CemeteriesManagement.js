...
import CemeteryCard from "components/khadamat/ekram/CemeteryCard";
...
import {
    ...
    setCemeteriesPageNo,
} from "redux/slices/cemeteriesSlice";

const CemeteriesManagement = () => {
    const dispatch = useDispatch();
    const { t } = useTranslation();
    const { cemeteries, cemeteriesLoading, page, pageCount } = useSelector(
        (state) => state.cemeteries
    );
